    ...
    */
    ...
    const goToSection = (section) => {
        if (unlockedSections.includes(section)) {
            ...
            const updatedUnlocked = Array.from(new Set([...unlockedSections, section]));
    ...
    const unlockNextSection = () => {
        ...
        if (nextIndex < formSections.length) {
            ...
            const updatedUnlocked = Array.from(new Set([...unlockedSections, nextSection]));
            setUnlockedSections(updatedUnlocked);
            localStorage.setItem("unlockedSections", JSON.stringify(updatedUnlocked));
    ...
    { /!EDUCATION/ }
    const [selectedSecCourse, setSelectedSecCourse] = useState(user?.selectedSecCourse);
    ...
    const handleUpdateEduct = async (e) => {
        ...
        if (selectedCourse && selectedSecCourse && selectedCourse === selectedSecCourse) {
            Swal.fire({
    ...
    const handleFinalize = () => {
        if (
            ...
            Swal.fire({
                ...
                text: "Please upload all required documents before finalizing your enlistment.",
            });
        } else {
            Swal.fire({
                icon: "success",
    ...
    return (
        <div>
                    ...
                    <table className="status-table" style={{ width: '100%' }}>
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td style={{ fontSize: "13px", textTransform: "uppercase" }}> {user?.lastname || ""}, {user?.firstname || ""}, {user?.middlename || ""} {user?.extension || ""} {course.initialDept || ''}</td>
                            </tr>
                            <tr>
                                <td style={{ fontSize: "13px" }}><strong>College/Program</strong></td>
                                <td style={{ fontSize: "13px" }}>{user?.selectedCourse || ""}</td>
                            </tr>
                            <tr>
            ...
            <div className="fulldetails">
                            ...
                            <div
                                ...
                                <div className="persofom-grid">
                                    <div className="uploads" style={{ marginBottom: '1rem', width: "100%" }}>
                                        <div>
                                            ...
                                            <p style={{ marginBottom: "20px", fontSize: "12px", fontStyle: "italic", marginTop: "10px", color: "orange" }}>
                                ...
                                <div className="unibtn" style={{ marginTop: '20px' }}>
                                    <button type="submit" onClick={handleUpdateProfile}>
                                        <i className="fa-solid fa-download"></i> Save and Proceed to Next Step
                                    </button>
                                </div>
                            </div>
                        </>
                        ...
                        <>
                            <div className="preprofile">
                                <div style={{ display: 'flex', flexDirection: 'column', width: '100%' }}>
                                            ...
                                            <div className="persofom-group ext" style={{ width: '50%' }}>
                                                ...
                                                <select
                                                    ...
                                                    onChange={e => {
                                                        ...
                                                        const selectedCourseObj = courses.find(course => course.title === selectedCourseTitle);
                                                        setInitialDept(selectedCourseObj?.initialDept || 'No department available');
                                                    }}
                                                >
                                                    <option value="" disabled>Select One</option>
                                                    {courses.map(course => (
                                            ...
                                            <div className="persofom-group ext" style={{ width: '50%' }}>
                                                ...
                                                <select
                                                    ...
                                                    onChange={e => {
                                                        ...
                                                        const selectedSecCourseObj = courses.find(course => course.title === selectedSecCourseTitle);
                                                        setInitialSecDept(selectedSecCourseObj?.initialDept || 'No department available');
                                                    }}
                                                >
                                                    <option value="" disabled>Select One</option>
                                                    {courses.map(course => (
                                    ...
                                    <div className="unibtn" style={{ marginTop: '20px', marginRight: '25px', paddingBottom: '20px' }}>
                ...
                <div className={`datafill ${fillsection === "family" ? "active" : ""} ${!unlockedSections.includes("family") ? "disabled" : ""}`}
                        ...
                        <>
                            <div className="preprofile">
                                <div style={{ display: 'flex', flexDirection: 'column', width: '100%' }}>
                                    ...
                                    <hr />
                                    <div style={{ marginTop: "15px" }}>
                                        <h4 style={{ color: "#333", marginLeft: "25px" }}>Father's Information</h4>
                                        <hr />
                                        <div className="persofom-group name-container">
                                            <div className="persofom-group name">
                                                <label>First Name*</label>
                                    ...
                                    <div style={{ marginTop: "15px" }}>
                                        <h4 style={{ color: "#333", marginLeft: "25px" }}>Mother's Information</h4>
                                        <hr />
                                        <div className="persofom-group name-container">
                                            <div className="persofom-group name">
                                                <label>First Name*</label>
                                    ...
                                    <div style={{ marginTop: "15px" }}>
                                        <h4 style={{ color: "orange", marginLeft: "25px" }}>Brothers and Sisters</h4>
                                        <hr />
                                        <div className="persofom-group name-container">
                                            <div className="persofom-group name">
                                    ...
                                    <div style={{ marginTop: "15px" }}>
                                        <h4 style={{ color: "green", marginLeft: "25px" }}>Guardian's Profile</h4>
                                        <hr />
                                        <div className="persofom-group name-container">
                                            <div className="persofom-group name">
                                            ...
                                            <div className="persofom-group name">
                                                ...
                                                <div className="persofom-input-container">
                                                    <input
                                                        ...
                                                        onChange={(e) => setGuarRelationship(e.target.value)}
                                                        type="text"
                                                    />
                                                </div>
                                            </div>
                                    ...
                                    <div className="unibtn" style={{ marginTop: '16px', marginRight: '25px', paddingBottom: '20px' }}>
                ...
                <div className={`datafill ${fillsection === "uploads" ? "active" : ""} ${!unlockedSections.includes("uploads") ? "disabled" : ""}`}
                        ...
                        <div className="preprofile">
                            <div className="uploads">
                                ...
                                <p style={{
                                    ...
                                    Thank you for filling out the form! The next step is to upload the remaining
