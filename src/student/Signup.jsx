...
const Signup = () => {
	...
	return (
		<div className="h-screen w-screen border grid grid-cols-2">
			{/* Left Section - Login */}

			<div className="login-section">
				<div className="border w-full max-w-2xl p-8 rounded-md border-zinc-300 shadow-2xs">
					...
					<p className="subtitle" style={{ fontSize: '10px' }}>
						Office of the Student Welfare and Services
					</p>
					<p className="subtitle" style={{ fontSize: '10px' }}>
				...
				<div className="forgot-reset">
					<div className="forgot-resetbg">
						...
						<p className="forgot-reset-description">
							To recover your password, please fill out this form. Make sure the
							information you provide matches what we have on file.
						</p>
						...
						<form className="forgot-reset-form" action="">
								...
								<input
									...
									onBlur={(e) =>
										(e.target.placeholder =
											window.innerWidth <= 768 ? 'MM/DD/YYYY' : '')
									}
							...
							<div className="forgot-input-group">
								...
								<div style={{ position: 'relative', width: '100%' }}>
									...
									<i
										className={`fa-solid ${
											newShowPassword ? 'fa-eye' : 'fa-eye-slash'
										}`}
							...
							<div className="forgot-reset-buttons">
								...
								<button type="submit" className="forgot-update-button">
									Update Password
								</button>
							</div>
						</form>
			...
			<div className="info-section">
				...
				<p className="section-text">
					By 2025, the College envisions to be a premier local institution of
					higher learning in Region 3 committed to the holistic development of
				...
				<p className="section-text">
					...
					imbued with values and attitudes responsive to the changing needs of
				...
				<ul className="goals-list">
					<li>
						Provide opportunities for high-level education in professional,
