            ...
            {loading ? (
                ...
                <div className="adcontainer">
                    ...
                    <div className={`preside ${sidebarVisible ? 'show' : 'hide'}`}>
                        <ul>
                            <li><a href="#" onClick={() => setActiveSection("welcome")}><i className="fa-solid fa-hand"></i> Dashboard</a></li>
                            <li><a href="#" onClick={() => setActiveSection("dashboard")}><i className="fa-solid fa-table-columns"></i> Profile/Enlistment</a></li>
                            <li><a href="#" onClick={() => setActiveSection("profile")}><i className="fa-solid fa-user"></i> Schedule</a></li>
                            <li><a href="#" onClick={() => setActiveSection("upload")}><i className="fa-solid fa-upload"></i> E-Form</a></li>
                            <li><a href="#" onClick={() => setActiveSection("announcement")}><i className="fa-solid fa-triangle-exclamation"></i> Summary of Grades</a></li>
                            <li><a href="#" onClick={() => setActiveSection("announcement")}><i className="fa-solid fa-triangle-exclamation"></i> Academic Evaluation</a></li>
                            <li><a href="#" onClick={() => setActiveSection("announcement")}><i className="fa-solid fa-triangle-exclamation"></i> Term Grades</a></li>
                            <li><a href="#" onClick={() => setActiveSection("announcement")}><i className="fa-solid fa-triangle-exclamation"></i> Faculty Evaluation</a></li>
                            <li><a href="#" onClick={() => setActiveSection("announcement")}><i className="fa-solid fa-triangle-exclamation"></i> Announcements</a></li>
                        </ul>
                    </div>
