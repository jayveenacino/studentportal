...
export default function Personal() {
	...
	// 				// Optional: Set the first region as default
	// 				const firstRegion = res.data[0]?.name || '';
	...
	// 				}));
	// 			} else {
	// 				console.error('Regions data is not an array or missing:', res.data);
	// 			}
	// 		} catch (error) {
	...
	// 				`https://psgc.rootscratch.com/province?id=${selectedRegion}`
	// 			);
	...
	// 			} else {
	// 				console.error(
	// 					'Provinces data is not an array or missing:',
	// 					response.data
	// 				);
	// 			}
	// 		} catch (error) {
	...
	// 		try {
	// 			const response = await axios.get(
	// 				`https://psgc.rootscratch.com/municipal-city?id=${selectedProvince}`
	// 			);
	...
	// 			} else {
	// 				console.error(
	// 					'Cities data is not an array or missing:',
	// 					response.data
	// 				);
	// 			}
	// 		} catch (error) {
	...
	// 		try {
	// 			const response = await axios.get(
	// 				`https://psgc.rootscratch.com/barangay?id=${selectedCity}`
	// 			);
	...
	// 			} else {
	// 				console.error(
	// 					'Barangays data is not an array or missing:',
	// 					response.data
	// 				);
	// 			}
	// 		} catch (error) {
